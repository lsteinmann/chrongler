...
The inaccurately named “example_workflow”-vignette explains the
functions and especially setting up the concordance in detail, see:
...
since this is my main use case. Of course, *chrongler* can be used with
data gathered elsewhere as well, as long as you keep to the formats
