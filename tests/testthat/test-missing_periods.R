...
test_that("warns and returns a single missing period", {
  present_periods <- c("First Period", "Second Period", "Missing Period")
  possible_periods <- c("First Period", "Second Period", "Third Period")
  expect_warning(
    missing_periods(present_periods = present_periods, possible_periods = possible_periods),
    "Missing Period"
  )
  expect_identical(
    suppressWarnings(
...
test_that("returns unique values for missing periods", {
  present_periods <- c("First Period", "Missing Period", "Second Period", "Missing Period")
  possible_periods <- c("First Period", "Second Period", "Third Period")
  expect_warning(
    missing_periods(present_periods = present_periods, possible_periods = possible_periods),
    "Missing Period"
...
test_that("warns and returns for multiple missing periods", {
  present_periods <- c("First Period", "Second Period",
